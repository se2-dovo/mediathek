...
/**
 * Mit Hilfe von Vormerkungskarte werden beim Vormerken eines Mediums alle
 * relevanten Daten notiert.
 * 
 * Sie beantwortet die folgenden Fragen: Welches Medium wurde vorgemerkt? Wer
 * hat das Medium ausgeliehen?Wer hat das medium Vorgemerkt und wie viele. Wann
 * wurde das Medium vorgemerkt?
 * 
...
public class Vormerkungskarte {
	 ...
	 * 
	 * @param vormerker
	 *            Ein Kunde, der das Medium ausleihen will.
	 * @param medium
	 *            Ein Medium.
	 * 
	...
	/**
	 * Fügt einen Vormerker zu dieser Karte hinzu, sofern dieser noch nicht
	 * vorhanden ist.
	 * 
	 * @param vormerker
	 * @require vormerker != null
	 ...
	 * zurück.
	 * 
	 * @return Eine formatierte Stringrepäsentation der Vormerkungskarte.
	...
	public String getFormatiertenString() {
		...
		for (int i = 0; this.getVormerker(i) != null; ++i) {
			formatstr = formatstr + "vorgemerkt von:" + "\n"
					+ this.getVormerker(0).getFormatiertenString();
		}
		return formatstr;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof Vormerkungskarte) {
			...
			if (!other.getMedium().equals(_medium))
				return false;
			for (int i = 0; i < VORMERKERZAHL; ++i) {
				Kunde kunde1 = other.getVormerker(i);
				Kunde kunde2 = this.getVormerker(i);
				if (kunde1 != kunde2)
					return false;
